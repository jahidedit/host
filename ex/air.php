...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    ...
    :root {
        ...
        body {
            ...
            background: url('https://images.unsplash.com/photo-1572746697108-c8d945684a5e?fit=crop&w=1600&q=80') no-repeat center center fixed;
...
<body oncontextmenu="return false;">
  ...
  <div class="swipe-topbar">
    ...
    <header>
     <div class="">
        <form method="GET" class="search-box">
          <a href="base.php" class="btn">All Bases</a>
           <a href="https://jahid.byethost15.com/profile.php" class="btn small-btn">
        <i class='fas fa-address-book'></i>  
        </a>
            <select name="exchange">
                <option value="AirHQ" <?= $exchange=='AirHQ'?'selected':'' ?>>AirHQ</option>
            </select>
         ...
         <?php if ($_SESSION['user'] == '474652'): ?>
        <button class="btn ybtn" onclick="document.getElementById('addModal').style.display='flex'">Add Number</button>
        <?php endif; ?>
        </div>
    </header>
    ...
    $class = 'others';
      if (stripos($row['designation'], 'COAS') !== false) $class = 'coas';
      elseif (stripos($row['designation'], 'ACAS') !== false) $class = 'acas';
